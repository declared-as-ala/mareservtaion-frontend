...
export function CardSkeleton() {
  return (
    <div className="space-y-4 p-6 rounded-xl border border-gray-200 bg-gray-50">
  ...
  return (
    <div className="space-y-3">
      {Array.from({ length: count }).map((_, i) => (
        <div key={i} className="flex items-center gap-4 p-4 rounded-xl border border-gray-200 bg-gray-50">
